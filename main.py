...
parser.add_argument('--load_size', dest='load_size', type=int, default=600, help='scale images to this size')
parser.add_argument('--fine_size', dest='fine_size', type=int, default=600, help='then crop to this size')
parser.add_argument('--D_loss', dest='D_loss', type=float, default=100, help='weight on L1 term in objective')
